            ...
            {users.map((u) => (
              <div key={u.id} className="py-3 flex items-center justify-between gap-3 text-xs">
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-full bg-[#0040e0]/10 text-[#0040e0] font-bold flex items-center justify-center shrink-0">
                    {u.fullName.charAt(0)}
                  </div>
                  <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Badge variant={u.isActive ? 'active' : 'expired'}>
