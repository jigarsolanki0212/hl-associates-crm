...
export function Drawer({
  ...
  children,
  side = 'right',
  width = 'w-[400px]', // Stitch 400px standard drawer
  className,
}: DrawerProps) {
  return (
    <DialogPrimitive.Root open={isOpen} onOpenChange={(open) => !open && onClose()}>
      <DialogPrimitive.Portal>
        ...
        <DialogPrimitive.Content
          className={cn(
            'fixed top-0 bottom-0 z-50 bg-white p-6 shadow-2xl border-l border-slate-200 duration-300 animate-in overflow-y-auto max-w-[100vw]',
