...
export default async function SettingsPage() {
  ...
  const initialSettings = {
    ...
    email: rawSettings?.email || 'bdm@hl-associates.in',
    phone: rawSettings?.phone || '+91 98988 96585',
    address: rawSettings?.address || '602, 603 & 606 Rashmi Growth Hub, Odhav to Vastral Road, S.P. Ring Road, Odhav, Ahmedabad, Gujarat 382415',
    taxId: rawSettings?.taxId || 'GSTIN-24AABCH1234F1Z5',
