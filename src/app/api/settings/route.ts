  ...
  try {
    ...
    return NextResponse.json({
      ...
      data: {
        ...
        email: settings?.email || 'bdm@hl-associates.in',
        phone: settings?.phone || '+91 98988 96585',
        address: settings?.address || '602, 603 & 606 Rashmi Growth Hub, Odhav to Vastral Road, S.P. Ring Road, Odhav, Ahmedabad, Gujarat 382415',
        taxId: settings?.taxId || 'GSTIN-24AABCH1234F1Z5',
